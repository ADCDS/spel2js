...
var javaString = {
     ...
     */
    join: function join(delimiter, elements) {
    ...
    format: function format(_format) {
        ...
        var i = 0;
        return _format.replace(/%s/g, function () {
            return args[i++];
        });
    },
     ...
     */
    copyValueOf: function copyValueOf(chars, offset, count) {
    ...
    CASE_INSENSITIVE_ORDER: {
        compare: function compare(s1, s2) {
...
var TypeReference = exports.TypeReference = {
    create: function create(position, typeNode, _dims) {
        ...
        node.getValue = function (state) {
            ...
            var typeName = node.getChildren()[0].getChildren()[0].getRaw();
